...
| Silhuetas dos carros | `silhuetas.js` — em tamanho de leitura, desenho a traço na cor do texto; em etiqueta, o perfil cheio na cor do carro. Há traço do DB12 (usado também por DB11, Vanquish e DBS) e do Vantage (e V12 Vantage), vetorizados de desenhos de terceiros — licença por confirmar. DB12 Volante, DBX707 e Valhalla continuam com o perfil antigo, só em linha |
