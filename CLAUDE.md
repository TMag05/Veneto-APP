...
| Silhuetas dos carros | `silhuetas.js` — em tamanho de leitura, desenho a traço na cor do texto; em etiqueta, o perfil cheio na cor do carro. Há traço do DB12, do DB11, do Vanquish, do DBS, do Vantage (e V12 Vantage) e do DB7, vetorizados de desenhos de terceiros — licença por confirmar. DBX707 e DB5 Superleggera ainda não têm traço: desenham o perfil da forma, só em linha. As versões Volante e o Valhalla saíram da lista a 26.09.2026; um acesso antigo com um deles aparece como DB12 |
