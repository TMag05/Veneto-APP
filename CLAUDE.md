...
| Silhuetas dos carros | `silhuetas.js` — em tamanho de leitura, desenho a traço na cor do texto; em etiqueta, o perfil cheio na cor do carro. Há traço do DB12, do DB11, do Vanquish, do DBS, do Vantage (e V12 Vantage), do DB7 e do DB5, vetorizados de desenhos de terceiros — licença por confirmar. O DBX707 ainda não tem traço: desenha o perfil da forma, só em linha. Nas jantes de arame do DB5, os raios foram redesenhados, e a figura do condutor saiu. As versões Volante e o Valhalla saíram da lista a 26.09.2026; um acesso antigo com um deles aparece como DB12 |
