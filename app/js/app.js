...
(function () {
  ...
  const ROTAS = [
    ...
    ['etapas', 'etapas'],
    ['estrada/:id', 'estrada'],
    /* O separador chamou-se Mapa até 20.09.2026 e Estradas até
       26.09.2026. Os links já partilhados continuam a abrir. */
    ['estradas', 'etapas'],
    ['mapa', 'etapas'],
  ...
  const ABAS_CONVIDADO = [
    ...
    { rota: '#/etapas', icone: 'mapa', rotulo: 'Etapas', nav: 'etapas' },
