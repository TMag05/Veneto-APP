...
**Durante** — o ecrã "Hoje" é **o dia inteiro, hora a hora**: sobre a paisagem, que fica parada atrás, a data, o título da etapa em Garamond de 44 px e os totais em pastilhas (quilómetros, tempo ao volante, ponto mais alto); por baixo, num cartão que corre por cima da paisagem, os blocos de hora — início e fim, o que acontece, onde —, com o momento em curso assinalado a cobre (*Agora* ou *A seguir*), os que já passaram esbatidos e o ritmo do troço entre duas paragens. **Cada bloco é um atalho para o roadbook**: abre o capítulo do dia já nesse momento. O roadbook é o detalhe que o Hoje não repete — cada momento com o tipo, a nota, as alterações, a distância desde a paragem anterior e o cartão da paragem, com fotografia, subtítulo e o caminho para a história. No fim de cada etapa, um link de Google Maps por troço e o GPX, para quem se afastar da caravana; a história de cada paragem apresentada como **promessa** — um excerto sobre a fotografia do sítio — que se revela à chegada; mapa monocromático com os carros a cores reais e uma **manchete** quando o grupo se junta num sítio; galeria com câmara nativa; concierge com cara, nome e promessa de resposta; contactos e SOS.
